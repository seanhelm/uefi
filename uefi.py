...
class MainWindow(QDialog):
    ...
    def initUI(self):
        self.setWindowTitle('Repo Init Assistance Tool')
    ...
    def extract_values(self):
        form = {}
        form['mu'] = self.box_mu.isChecked()
        form['tianocore'] = self.box_tianocore.isChecked()
        form['fg'] = self.box_fg.isChecked()
        form['arm'] = self.box_arm.isChecked()
        form['intel'] = self.box_intel.isChecked()
        form['manufacturer'] = self.text_manufacturer.text()
        form['device'] = self.text_device.text()
